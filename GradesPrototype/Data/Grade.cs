...
namespace GradesPrototype.Data
{
    ...
    interface IUser
    {
        ...
        //string _password; // = Guid.NewGuid().ToString(); // Generate a random password by default
        string Password
        {
            set;
            //{
    ...
    public class Student: IUser, IComparable<Student>
    {
        ...
        //Added Code
        public string _password = Guid.NewGuid().ToString(); // Generate a random password by default
        public string UserName { get; set; }
